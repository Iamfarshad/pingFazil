...
const Carcall = () => {
  ...
  const electricians = [
    { name: "Faseeh", phone: "+91 63808 87098" },
    { name: "Ishtiyaq", phone: "+91 86678 48202" },
    { name: "Arshad", phone: "+91 89252 14747" },
    { name: "Imtiyaz", phone: "+91 90801 13262" },
    { name: "Nasrullah", phone: "+91 99402 23903" },
    { name: "Shameel", phone: "+91 98944 87722" },
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#8ea3c6]">
      ...
      <View className="flex-row items-center justify-between bg-[#365486] px-4 py-4 shadow-lg rounded-b-3xl">
        ...
        <Text className="text-white text-xl font-bold">Cab Service</Text>
